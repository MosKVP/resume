...
\begin{center}
	...
	\vspace{1mm}
	\headercontactstyle{\faEnvelope\ kavinpon@hotmail.com} | \headercontactstyle{\faMobile\ +66863266507} | \headercontactstyle{\faMapMarker\ Bangkok, Thailand} | \headercontactstyle{\faLinkedin\ linkedin.com/in/kavinpon}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Experience
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{cvskills}
	...
	{{\begin{tabular}{ L{2.5cm} l }
		\skilltypestyle{ Tech Stack: } & {\skillsetstyle{ Kotlin, Flutter, Golang, TypeScript, node.js, React.js, PostgreSQL, MongoDB}} \\
		\skilltypestyle{ Platform: }   & {\skillsetstyle{ AWS, GCP, OpenShift, Kubernetes, Docker, Control-M}}                          \\
	\end{tabular}}}
\end{cvskills}
